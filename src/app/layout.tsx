...
export const metadata: Metadata = {
  ...
  description: "Discover artisan coffee crafted with passion. Premium beans, expert baristas, and the perfect coffee moment await you at BrewHaven.",
  keywords: "coffee shop, espresso, cappuccino, coffee drinks, artisan coffee, specialty coffee",
  ...
  openGraph: {
    title: "BrewHaven - Premium Coffee Shop",
    description: "Discover artisan coffee crafted with passion. Premium beans, expert baristas, and the perfect coffee moment await you.",
    type: "website",
    siteName: "BrewHaven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765800052911-imcos76d.jpg",
        alt: "BrewHaven Premium Coffee"
      }
    ],
    url: "https://brewhaven.local"
  },
  twitter: {
    card: "summary_large_image",
    title: "BrewHaven - Premium Coffee Shop",
    description: "Discover artisan coffee crafted with passion at BrewHaven.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765800052911-imcos76d.jpg"]
  }
};
